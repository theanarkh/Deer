...
int Deer::HTTP::HTTP_Parser::on_message_begin(llhttp_t* parser)
        {
            major_version = 0;
            minor_version = 0;
            upgrade = 0;
...
int Deer::HTTP::HTTP_Parser::on_status(llhttp_t* parser, const char* at, size_t length)
{
    status.append(at, length);
    return 0;
}

int Deer::HTTP::HTTP_Parser::on_url(llhttp_t* parser, const char* at, size_t length)
{ 
    url.append(at, length);
    return 0;
}

int Deer::HTTP::HTTP_Parser::on_header_field(llhttp_t* parser, const char* at, size_t length)
{   
    keys.push_back(string(at, length));
    return 0;
}

int Deer::HTTP::HTTP_Parser::on_header_value(llhttp_t* parser, const char* at, size_t length)
{
    values.push_back(string(at, length));
    return 0;
}

int Deer::HTTP::HTTP_Parser::on_headers_complete(llhttp_t* parser)
{
...
int Deer::HTTP::HTTP_Parser::on_body(llhttp_t* parser, const char* at, size_t length)
{
...
int Deer::HTTP::HTTP_Parser::on_message_complete(llhttp_t* parser)
{
...
int Deer::HTTP::HTTP_Parser::parse(const char* data, int len) {
...
void Deer::HTTP::HTTP_Parser::print() {
...
llhttp_settings_t Deer::HTTP::HTTP_Parser::settings = {
    [](llhttp_t * parser) {
